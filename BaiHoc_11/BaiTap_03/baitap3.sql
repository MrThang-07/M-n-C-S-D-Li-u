CREATE DATABASE RikkeiClinicDBbt3;
USE RikkeiClinicDBbt3;
...
-- =====================================================
-- PHẦN 1: PHÂN TÍCH ĐẦU VÀO - ĐẦU RA


-- Dữ liệu đầu vào:
-- p_total_cost : Tổng chi phí viện phí
...
-- OUT : dùng để trả kết quả tính toán ra ngoài procedure

-- =====================================================
-- PHẦN 2: GIẢI PHÁP & CÁC BƯỚC THỰC HIỆN
...
-- Bước 3:
-- Nếu dữ liệu hợp lệ:
-- - BHYT   => bệnh nhân đóng 20%
-- - VIP    => giảm 10%
-- - THUONG => đóng 100%

-- Bước 4:
-- Trả kết quả và thông báo:
-- 'Đã tính toán xong'

-- =====================================================
-- PHẦN 3: TRIỂN KHAI MÃ NGUỒN
